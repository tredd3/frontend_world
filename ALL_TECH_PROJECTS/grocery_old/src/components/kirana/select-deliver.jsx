...
@connect(
  ...
  dispatch => {
    return {
      ...
      saveStoreWithAddress: function (kirana, history) {
        dispatch(saveStoreWithAddress(kirana, history));
      },
...
class SelectAndDeliver extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      value: "",
  ...
  selectKirana = () => {
    if (this.state.selecting !== 'others') {
      let selectedK = this.state.invites.filter(store => {
        return parseInt(this.state.value) === store.StoreId;
      });
      this.props.saveStoreWithAddress(selectedK[0], this.props.history);
    }
    else {

      let selectedK = this.props.allKiranas.filter(store => {
        return parseInt(this.state.value) === store.StoreId;
      });
      this.props.saveStoreWithAddress(selectedK[0], this.props.history);
    }
...
export default SelectAndDeliver;
